...
## Задание 1. Поиск билетов (обязательное к выполнению) <a href="https://github.com/RavenRVS/QAI_HW14_T1/tree/master/src">(моё решение) </a>
...
## Задание 2*. Самый быстрый (необязательная задача) <a href="https://github.com/RavenRVS/QAI_HW14_T1/pull/1">(моё решение) </a>
